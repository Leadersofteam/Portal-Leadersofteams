      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
          ...
          >
            ...
            <div style={{ display: 'flex', height: 5, borderRadius: 3, background: 'rgba(255,255,255,0.85)' }} />
            <div style={{ display: 'flex', height: 5, borderRadius: 3, background: 'rgba(255,255,255,0.5)' }} />
          </div>
